    ...
    <>
      <div className="flex justify-between items-center">
        {label && (
          <label
            htmlFor={name}
            className={`
                    flex justify-start text-[14px] font-medium text-gray-2 tracking-wide ${
        ...
        {forgotPassword && (
          <a
            className="forgot-link text-purple-1 text-[14px] mb-2"
            tabIndex="0"
            onKeyDown={(e) => {
      ...
      >
        ...
        {(name === "password" ||
          ...
          name === "oldPassword") && (
          <span
            className="eye-span absolute right-3 top-4 text-gray-1 text-[20px] cursor-pointer"
