    ...
    const iconMap = {
        ...
        Education: (
            <svg
                ...
                width={size ? size : "24"}
                height={size ? size : "24"}
                viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke="currentColor" class="w-6 h-6" >
        ...
        Info: (
            <svg
                ...
                <g clip-path="url(#clip0_1948_60812)">
        ...
        Upload: (
            <svg
                ...
                width={size ? size : "16"}
                height={size ? size : "16"}
                xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-cloud-arrow-up" viewBox="0 0 16 16">
